...
class Payment(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Сумма платежа (в валюте транспорта)')
    amount_rub = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Сумма платежа в рублях')
    currency = models.ForeignKey('app.Currency', on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Валюта транспорта')
    exchange_rate = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True, verbose_name='Курс на момент создания')
    ...
    delivery_rub = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Стоимость доставки в рублях')
